    ...
    <section className="space-y-6">
      ...
      <div className="card">
        ...
        <div className="flex gap-3">
          {project.githubUrl && (
            <a className="px-3 py-1 rounded-xl border hover:border-primary-400" href={project.githubUrl} target="_blank">
              GitHub
            </a>
          )}
          {project.liveUrl && (
            <a className="px-3 py-1 rounded-xl border hover:border-primary-400" href={project.liveUrl} target="_blank">
              Demo
            </a>
          )}
          <Link className="px-3 py-1 rounded-xl border hover:border-primary-400" href="/projects">
            Volver a proyectos
          </Link>
        </div>
      </div>
